...
from views.product_module_view import ProductTypeManagementViewSet,ProductListReadOnlyViewSet,ProductTypeViewSet,ProcessTypeManagementViewSet,ProcessTypeViewSet,ProductListViewSet,CustomerListViewSet,ProductManagementViewSet,ProductDetailReadOnlyViewSet,ProcessManagementViewSet

from views.material_module_view import MaterialListViewSet,UomListViewSet,UomManagementViewSet,MaterialManagementViewSet,MrpReadOnlyViewSet,MrpManagementViewSet,SupplierListViewSet 


from views.production_module_view import MachineManagementViewSet,MachineViewSet,OperatorManagementViewSet,OperatorViewSet,ProductionReportManagementViewSet,ProductionReportReadOnlyViewSet,ProductionPriorityViewSet,ReceiptSubcontScheduleManagementViewSet,ProductDeliverSubcontReadOnlyViewSet,ProductionListViewSet

from views.delivery_module_view import VehicleManagementViewSet,VehicleViewSet,DriverManagementViewSet,DriverViewSet,DeliveryNoteCustomerManagementViewSet,DeliveryNoteCustomerReadOnlyViewSet,DeliveryNoteSubcontManagementViewSet,DeliveryNoteSubcontReadOnlyViewSet,ProductDeliverManagementViewSet,ProductDeliverySubcontManagementViewSet,ProductListSubcontReadOnlyViewSet,ProductOrderListViewSet,DeliveryScheduleListViewSet

from views.warehouse_module_view import UomWarehouseMaterialViewSet,MaterialOrderReadOnlyViewSet,DeliveryNoteMaterialManagementViewSet,DeliveryNoteMaterialReadOnlyViewSet,ReceiptNoteSubcontManagementViewSet,ReceiptNoteSubcontReadOnlyViewSet,ProductDeliverSubcontListViewSet,MaterialReceiptManagementViewSet,MaterialReceiptScheduleReadOnlyViewSet,SubcontReceiptManagementViewSet,ReceiptSubcontScheduleListViewSet,WarehouseFinishGoodViewSet,WarehouseMaterialManagementViewSet,WarehouseProductManagementViewSet,WarehouseWipViewSet

from views.ppic_dashboard_view import MonthlyProductionReportViewSet,ProductOrderedViewSet,MaterialOrderedViewSet
