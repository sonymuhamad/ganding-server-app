...
class CreateUpdateDeleteModelViewSet(mixins.CreateModelMixin,
                            mixins.UpdateModelMixin,
                            mixins.DestroyModelMixin,
                            GenericViewSet):
    """
...
class GetModelViewSet(mixins.ListModelMixin,
                   GenericViewSet):
    '''
...
class CreateDeleteModelViewSet(mixins.CreateModelMixin,
                            mixins.DestroyModelMixin,
                            GenericViewSet):
    '''
