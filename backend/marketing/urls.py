...
from views.sales_order_module_view import SalesOrderListReadOnlyViewSet,DeliveryScheduleManagementViewSet,ProductOrderManagementViewSet,SalesOrderManagementViewSet,DeliveryScheduleReadOnlyViewSet,ProductDeliverCustomerReadOnlyViewSet

from views.invoice_module_view import InvoiceManagementViewSet,InvoiceReadOnlyViewSet,SalesOrderDoneListViewSet

from views.delivery_note_module_view import DeliveryNoteListViewSet

from views.marketing_dashboard_view import ReportProductOrderViewSet,InProgressProductOderViewSet,FinishedSalesOrderViewSet
